...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 3:
      ...
      integrated_df['start_time'] = (integrated_df['start_time'] - pd.Timestamp("1970-01-01")) // pd.Timedelta('1s')
      integrated_df['end_time'] = (integrated_df['end_time'] - pd.Timestamp("1970-01-01")) // pd.Timedelta('1s')
